      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <Card className="shadow-professional bg-card border-border">
              <CardHeader>
                <CardTitle className="text-2xl text-gradient-primary">
                  Proje Talebi Gönderin
                </CardTitle>
                <CardDescription>
                  Projenizin detaylarını paylaşın, size en uygun çözümü sunalım
                </CardDescription>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      onChange={handleInputChange}
                      placeholder="Projenizin detaylarını, veri setinizin büyüklüğünü, hangi analizlere ihtiyacınız olduğunu ve teslim tarihini belirtiniz..."
                      rows={6}
                      required
                    />
                  </div>
              ...
              <CardContent>
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-foreground font-medium">Kapalı</span>
                  </div>
                </div>
              </CardContent>
            </Card>
